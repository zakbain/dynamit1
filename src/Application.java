...
public class Application {
    private static final String text = "WASHINGTON Unable to rest their eyes on a colorful photograph or boldface heading that could be easily skimmed and forgotten about, Americans collectively recoiled Monday when confronted with a solid block of uninterrupted text.\n" +
            "\n" +
    ...
    public static void main(String[] args) {
        Map<String, Integer> wordCounts = WordCounter.calculateSortedWordCount(text);
